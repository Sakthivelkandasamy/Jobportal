<!-- Footer -->
  <div id="footer"> 
        ...
        <div class="row">
		  <div class="col-xl-4 col-md-12">
			<div class="utf-footer-item-links">
				<a href="<?= base_url(); ?>"><img src="<?= base_url(); ?>assets/img/logo.png" alt="" title="" />
    ...
    <div class="utf-footer-copyright-item">
      <div class="container">
        <div class="row">
          <div class="col-xl-12"><p>Copyright &copy; <?php echo date('Y'); ?> by <a href="https://softechbay.com/">softechbay</a></strong>. All rights reserved</p></div>
        </div>
      </div>
    </div>
