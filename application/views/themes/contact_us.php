        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 d-flex flex-column">
              <a class="contact-btns" href="<?= base_url('about'); ?>">About JobsClub</a>
              <a class="contact-btns" href="<?= base_url('employers'); ?>">Post New Job</a>
              <a class="contact-btns" href="<?= base_url('auth/registration'); ?>">Create New Account</a>
            </div>
            <div class="col-lg-8">
